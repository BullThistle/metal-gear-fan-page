...
development5 = "The game was produced under the request of Konami's European division to release a Game Boy Color version of Metal Gear Solid. The game's director, Shinta Nojiri, would later go on to direct Metal Gear Acid and its sequel, Metal Gear Acid 2, both released for the PlayStation Portable, while character designer Ikuya Nakamura would go on to direct the Boktai series on Game Boy Advance and Nintendo DS."

name6 = "Metal Gear Solid 2: Sons of Liberty"

release6 = "November 13, 2001"

description6 = "Metal Gear Solid 2: Sons of Liberty is an action-adventure stealth game developed and published by Konami for the PlayStation 2 in 2001. It is the fourth Metal Gear game written and directed by Hideo Kojima and serves as the direct sequel to the original Metal Gear Solid. An expanded edition, titled Metal Gear Solid 2: Substance, was released the following year for Xbox and Microsoft Windows in addition to the PlayStation 2.
...
gameplay7 = "The gameplay of The Twin Snakes was altered to resemble that of Metal Gear Solid 2: Sons of Liberty. While all of the original areas and enemies were kept, new ways for the player to combat them were introduced, such as the ability to shoot from a first-person view. Enemy AI was improved, giving enemy soldiers the ability to communicate with each other and detect the player more intelligently with senses of sight and sound enhanced."

story7 = "The game is a remake of Metal Gear Solid, originally developed by Konami for the PlayStation in 1998."

development7 = "The Twin Snakes was first announced in 2003 by Nintendo of America, confirming that Silicon Knights would be developing under the guidance of Metal Gear creator Hideo Kojima and Mario creator Shigeru Miyamoto.
...
name11 = "Metal Gear Solid: Portable Ops"

release11 = "December 5, 2006"

description11 = "Metal Gear Solid: Portable Ops, officially abbreviated MPO, is an action-adventure stealth video game directed by Masahiro Yamamoto and written by Gakuto Mikumo, with series creator Hideo Kojima acting as a producer. Portable Ops was developed by Kojima Productions and published by Konami in 2006 for the PlayStation Portable (PSP). Metal Gear Solid: Portable Ops Plus (officially abbreviated MPO+), the game's stand-alone expansion, focused primarily on online play and was released for the PSP in 2007 in Japan and in 2008 in other regions. In June 2016, both games were made compatible with the PlayStation Vita and PlayStation TV as downloadable titles via the PlayStation Store.
...
gameplay11 = "Unlike the previous titles on PSP, Metal Gear Acid and Metal Gear Acid 2, which were turn-based tactical games with stealth elements, MPO retains the action-based gameplay from the console iterations, drawing heavily from Metal Gear Solid 3: Snake Eater and utilizing the camera system from the Subsistence edition of the game.

The main addition to MPO is the Comrade System. Instead of the solo missions of previous MGS games, MPO goes for a squad-based approach, with Snake having to recruit allies and form a team of trained specialists. Before each mission, the player must compose a four-man squad. The squad is then sent into battle. Each member of Snake's squad has his or her own strengths and weaknesses. While some units are best utilized on the battlefield, others may specialize in producing items, healing allies, or providing intel for each of the game's maps.
...
gameplay12 = "In MGS4, players assume the role of an aged Solid Snake (also referred to as Old Snake), using stealth, close quarters combat, and traditional Metal Gear combat. The overhead third-person camera of earlier games has been replaced by a streamlined view and over-the-shoulder camera for aiming a weapon, with an optional first-person view at the toggle of a button.
...
Set in 1974 in Costa Rica, the game follows the exploits of returning protagonist Snake as he runs the mercenary unit Militaires Sans Frontières (Soldiers Without Borders)."

gameplay13 = "Peace Walker consists of two primary gameplay modes: Mission and Mother Base. Mission are the actual action sequences of the game, where the player must infiltrate an enemy territory or fight a boss, whereas Mother Base is an army management mode similar to the briefing screen in Portable Ops.
